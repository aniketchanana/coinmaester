---
description: gRPC contract conventions across proto, NestJS, and Python
globs: packages/proto/**,apps/api-backend/src/grpc/**,apps/python-worker/generated/**,apps/python-worker/grpc_client.py
alwaysApply: false
---
