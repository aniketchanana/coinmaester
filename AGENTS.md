...
| Worker | `apps/python-worker` | Python 3.14, uv, RabbitMQ consumer, Anthropic SDK (LM Studio) |
...
External dependency: LM Studio (or compatible) at `ANTHROPIC_BASE_URL` (default `http://localhost:1234`) for LLM inference.
